 ...
 */
package com.lab536.project.test;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		PcapIf device = alldevs.get(6); // Pick one
		...
		JPacketHandler<String> jpacketHandler = new JPacketHandler<String>() {
			...
			public void nextPacket(JPacket packet, String user) {
				...
				if(packet.hasHeader(tcp)){
					...
					System.out.println("TCP:\tdest port:\t" + tcp.destination());
					System.out.println("TCP:\tsource port:\t" + tcp.source());
				
				} else if (packet.hasHeader(udp)){
				
					System.out.println("UDP:\tdest port:\t" + udp.destination());
					System.out.println("UDP:\tsource port:\t" + udp.source());
				
				} else if (packet.hasHeader(icmp)){
					
					System.out.println("ICMP:\tICMP code:\t" + icmp.code());
				...
				if(packet.hasHeader(ip)){
					...
					address = ip.source();
					System.out.println("IP:\tsource:\t\t" + FormatUtils.ip(address));
					address = ip.destination();
					System.out.println("IP:\tdestination:\t" + FormatUtils.ip(address));
				...
				if(packet.hasHeader(eth)){
					...
					System.out.println("Eth:\tprotocol:\t" + eth.getName());
					mac = eth.source();
					System.out.println("Eth:\tsource:\t\t" + FormatUtils.mac(mac));
					mac = eth.destination();
					System.out.println("Eth:\tdestination:\t" + FormatUtils.mac(mac));
